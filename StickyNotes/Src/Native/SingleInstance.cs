...
namespace StickyNotes.Native
{
	...
	{
		static Mutex mutex = new Mutex(true, "MISoftware-" + Consts.AppName);// este nome está harcoded no Setup Inno: previne instalar/desinstalar caso app esteja rodando
		...
		static public bool IsRunningAndAcquire()
		{
			if(!mutex.WaitOne(TimeSpan.Zero, true))
			{
				...
				{
					User32.ShowWindow(t.MainWindowHandle, User32.WindowShowStyle.SW_SHOW);
